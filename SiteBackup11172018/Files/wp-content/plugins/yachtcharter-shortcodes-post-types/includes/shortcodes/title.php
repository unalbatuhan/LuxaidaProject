...
function title_shortcode( $atts, $content = null ) {
	...
	if ($type == 'title1') {
		$output = '<h3>' . $content . '</h3><div class="title-block7"></div>';
	} elseif ( $type == 'title2' ) {
		$output = '<h4>' . $content . '</h4><div class="title-block5"></div>';
	} elseif ( $type == 'title3' ) {
		$output = '<h4 class="yachtchartercenter">' . $content . '</h4><div class="title-block5 yachtchartercenter"></div>';
	} elseif ( $type == 'title4' ) {
