...
extract($attr);
?>
<div class="ajax-filter-cover" data-style="<?php echo (isset($st_style) && $st_style != '') ? $st_style : '1' ; ?>" data-number="<?php echo (isset($st_number) && $st_number != '') ? $st_number : '3'; ?>" data-post-type="<?php echo $data_post_type; ?>">
