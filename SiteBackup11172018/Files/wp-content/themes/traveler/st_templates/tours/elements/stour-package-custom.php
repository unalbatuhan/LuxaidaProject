            ...
            if (!empty((array)$tour_package_custom)) {
                foreach ($tour_package_custom as $k => $v) {
                    ...
                    <tr>
                        ...
                        <td data-name="<?php echo __('Hotel name', ST_TEXTDOMAIN); ?>"><input type="text" class="hotel-name" value="<?php echo $v->hotel_name; ?>"/></td>
                        <td data-name="<?php echo __('Hotel star', ST_TEXTDOMAIN); ?>"><input type="number" min="0" max="5" step="0.5" class="hotel-star"
                                   value="<?php echo $v->hotel_star; ?>"/></td>
                        <td data-name="<?php echo __('Hotel price', ST_TEXTDOMAIN); ?>"><input type="text" class="hotel-price" value="<?php echo $v->hotel_price; ?>"/></td>
                    </tr>
                    <?php
                }
            }
