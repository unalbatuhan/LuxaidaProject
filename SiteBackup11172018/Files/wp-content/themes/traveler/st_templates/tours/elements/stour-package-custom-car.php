            ...
            if (!empty((array)$tour_package_custom)) {
                foreach ($tour_package_custom as $k => $v) {
                    ...
                    <tr>
                        ...
                        <td data-name="<?php echo __('Car name', ST_TEXTDOMAIN); ?>"><input type="text" class="car-name" value="<?php echo $v->car_name; ?>"/></td>
                        <td data-name="<?php echo __('Price', ST_TEXTDOMAIN); ?>"><input type="text" class="car-price" value="<?php echo $v->car_price; ?>"/></td>
                        <td data-name="<?php echo __('Quantity', ST_TEXTDOMAIN); ?>"><input type="number" class="car-quantity" value="<?php echo $v->car_quantity; ?>"/></td>
                    </tr>
                    <?php
                }
            }
