...
<tr>
    ...
    <td>
        ...
        <?php if($use_agent_info){ ?>
            ...
            <p style="margin-top:10px;"><strong> <?php echo __('Journey', ST_TEXTDOMAIN) ?>:</strong> <?php echo $transfer_from . ' - '. $transfer_to; ?></p>
        ...
        <?php } ?>
        <p><strong><?php echo __('Passengers', ST_TEXTDOMAIN) ?>:</strong> <?php echo $passenger; ?></p>
        <?php 
