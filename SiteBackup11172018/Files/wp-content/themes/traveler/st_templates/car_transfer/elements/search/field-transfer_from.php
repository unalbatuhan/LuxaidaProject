...
if(!empty($data)):
	?>
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left form-group-transfer <?php echo $class_car; ?>">
	<label for="field-car-dropoff"><?php echo $title; ?></label>
