...
?>
    <form method="post" action="" id="form-booking-inpage" class="form-has-guest-name">
        ...
        <div class="booking-item-dates-change" data-booking-period="<?php echo $booking_period; ?>" data-period="<?php echo esc_attr($date->format(TravelHelper::getDateFormat())) ?>"
                                ...
                                <tr>
                                    <td width="80%">
                                        <label for="<?php echo $val['extra_name']; ?>"
                                               class="ml20"><?php echo $val['title'] . ' (' . TravelHelper::format_money($val['extra_price']) . ')'; ?>
                                            <?php
                                    ...
                                    <td width="20%">
                                        <select style="width: 100px" class="form-control app"
                                                name="extra_price[value][<?php echo $val['extra_name']; ?>]" id="">
                                            <?php
