...
<div class="row">
    <div class="col-md-3">
        <div class="add-service-progress">
            <div class="st-create">
                <h3 class="pull-left"><?php esc_html_e('Room Information',ST_TEXTDOMAIN) ?></h3>
            </div>
            <div class="sticky-box" data-width-from=".add-service-progress">
                <ul>
                    ...
                    <li data-step="#step_detail"><i class="fa fa-building"></i> <?php esc_html_e('Room Info',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_price_setting"><i class="fa fa-money"></i> <?php esc_html_e('Price Settings',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_room_facility"><i class="fa fa-power-off"></i> <?php esc_html_e('Room Facility',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_other_facility"><i class="fa fa-power-off"></i> <?php esc_html_e('Other Facility',ST_TEXTDOMAIN) ?></li>
            ...
            <div class="add_service_step_wraps">
                <div class="add_service_step active" id="step_general">
                    <div class="form-group form-group-icon-left">
                        ...
                        <input data-rules="required" id="title" name="st_title" type="text" placeholder="<?php st_the_language('user_create_room_title') ?>" class="form-control" value="<?php echo stripslashes(STInput::request("st_title",$title)) ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <input data-rules="required" id="number_room" name="number_room" placeholder="<?php _e('Number of this room', ST_TEXTDOMAIN); ?>" type="text" min="1" value="<?php echo STInput::request('number_room',get_post_meta( $post_id , 'number_room' , true)); ?>"  class="form-control number" >
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('number_room'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Number field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class='form-group form-group-icon-left'>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <input data-rules="required" id="price" name="price" type="text" placeholder="<?php _e('Pricing', ST_TEXTDOMAIN); ?>" class="form-control number" value="<?php echo STInput::request('price',get_post_meta($post_id , 'price' , true )) ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('price'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Pricing field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                ...
                <div class="add_service_step" id="step_room_facility">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                                <input data-rules="required" id="adult_number" name="adult_number" type="text" min="1" value="<?php echo STInput::request('adult_number',get_post_meta( $post_id , 'adult_number' , true)); ?>"  class="form-control number">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('adult_number'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Adult Number field is required.",ST_TEXTDOMAIN),'required') ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                                <input data-rules="required" id="children_number" name="children_number" type="text" min="1" value="<?php echo STInput::request('children_number',get_post_meta( $post_id , 'children_number' , true)); ?>"  class="form-control number">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('children_number'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Children Number field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                                <input data-rules="required" id="bed_number" name="bed_number" type="text" min="1" class="form-control number" value="<?php echo STInput::request('bed_number',get_post_meta( $post_id , 'bed_number' , true)); ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('bed_number'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Beds Number field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                                <input data-rules="required" id="room_footage" name="room_footage" type="text"  placeholder="<?php st_the_language('user_create_room_room_footage')?>" class="form-control number" value="<?php echo STInput::request('room_footage',get_post_meta( $post_id , 'room_footage' , true)); ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('room_footage'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Room Footage field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                <div class="add_service_step" id="step_other_facility">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-icon-left">
