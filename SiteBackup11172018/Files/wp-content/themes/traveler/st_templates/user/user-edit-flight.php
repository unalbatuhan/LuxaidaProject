...
<div class="row">
    <div class="col-sm-3">
        <div class="add-service-progress">
            <div class="st-create">
                <h3 class="pull-left"><?php esc_html_e('Flight Info',ST_TEXTDOMAIN) ?></h3>
            </div>
            <div class="sticky-box" data-width-from=".add-service-progress">
                <ul>
                    ...
                    <li data-step="#step_flight_time"><i class="fa fa-paper-plane"></i> <?php esc_html_e('Flight Time',ST_TEXTDOMAIN) ?></li>
                    <?php
                    if(!empty($post_id)){
                        ?>
                        <li data-step="#step_availability"><i class="fa fa-calendar"></i> <?php esc_html_e('Booking Details',ST_TEXTDOMAIN) ?> </li>
                    <?php } ?>
                    <li data-step="#step_tax_options"><i class="fa fa-building"></i> <?php esc_html_e('Tax Options',ST_TEXTDOMAIN) ?></li>
            ...
            <div class="add_service_step_wraps">
                <div class="add_service_step active" id="step_general">
                    <div class="form-group form-group-icon-left">
                        ...
                        <input data-rules="required" id="title" name="st_title" type="text" placeholder="<?php echo __('Name of flight', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo stripslashes(STInput::request("st_title",$title) ); ?>">
                ...
                <div class="add_service_step" id="step_flight_time">
                ...
                <?php if(!empty($post_id)){?>
                <div class="add_service_step" id="step_availability">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-icon-left">
                ...
                <?php }?>
                <div class="add_service_step" id="step_tax_options">
