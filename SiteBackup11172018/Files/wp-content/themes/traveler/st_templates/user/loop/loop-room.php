            ...
            <div class="col-md-6">
                ...
                <ul class="booking-item-features booking-item-features-sign clearfix">
                    ...
                    <?php if($child=get_post_meta(get_the_ID(),'children_number',true)): ?>
                        <li rel="tooltip" data-placement="top" title="" data-original-title="<?php _e("Children",ST_TEXTDOMAIN)?>"><i class="im im-children"></i><span class="booking-item-feature-sign">x <?php echo esc_html($child) ?></span>
                        </li>
                    <?php endif; ?>
