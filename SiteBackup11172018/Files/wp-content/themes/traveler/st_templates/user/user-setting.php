...
<div class="row">
    <div class="col-md-5">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group form-group-icon-left">
                <label for="st_phone"><?php echo __('About Yourself', ST_TEXTDOMAIN); ?></label><i class="fa fa-user input-icon"></i>
                <textarea rows="7" name="st_bio" class="form-control" ><?php echo get_user_meta($data->ID , 'st_bio' , true); ?></textarea>
            </div>
            <div class="gap gap-small"></div>
