...
<div class="row">
    <div class="col-md-3">
        <div class="add-service-progress">
            <div class="st-create">
                <h3 class="pull-left"><?php esc_html_e('Rental Room Information',ST_TEXTDOMAIN) ?></h3>
            </div>
            <div class="sticky-box" data-width-from=".add-service-progress">
                <ul>
                    ...
                    <li data-step="#step_facility"><i class="fa fa-power-off"></i> <?php esc_html_e('Room Facility',ST_TEXTDOMAIN) ?></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="col-md-9">
        ...
        <form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
            ...
            <div class="add_service_step_wraps">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <input data-rules="required" type="text" name="room_parent" placeholder="<?php st_the_language('user_create_room_search') ?>" id="room_parent" data-pl-name="<?php echo get_the_title($room_parent) ?>" data-pl-desc="" value="<?php echo esc_html($room_parent) ?>" class="st_post_select_ajax" data-author="<?php echo esc_attr($data->ID)?>" data-post-type="st_rental" style="width: 100%">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('room_parent'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Rental field is required.",ST_TEXTDOMAIN),'required') ?>
                ...
                <div class="add_service_step" id="step_facility">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
