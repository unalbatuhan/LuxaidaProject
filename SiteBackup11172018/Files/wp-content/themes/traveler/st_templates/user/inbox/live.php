...
if(!empty($message_data)){
    ...
    <div class="st-inbox-body-detail" id="wb-partner-message-detail">
        ...
        if(!empty($message_data['post_id'])){
            echo '<span class="post_name">'.esc_html__('In: ',ST_TEXTDOMAIN).'<a target="_blank" href="'.esc_url(get_permalink($message_data['post_id'])).'">'.get_the_title($message_data['post_id']).'</a></span>';
        }
