...
<!--            <h3 class="service-progress-title">--><?php //esc_html_e('Hotel Information',ST_TEXTDOMAIN) ?><!--</h3>-->
            <div class="st-create">
                <h3 class="pull-left"><?php esc_html_e('Hotel Information',ST_TEXTDOMAIN) ?></h3>
            </div>
            <div class="sticky-box" data-width-from=".add-service-progress">
                <ul>
                    ...
                    <li data-step="#step_hotel_detail"><i class="fa fa-building"></i> <?php esc_html_e('Hotel Detail',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_price_setting"><i class="fa fa-money"></i> <?php esc_html_e('Price Settings',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_check_in_out_time"><i class="fa fa-clock-o"></i> <?php esc_html_e('Check in/out time',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_other_options"><i class="fa fa-dashboard"></i> <?php esc_html_e('Other Options',ST_TEXTDOMAIN) ?></li>
                    <li data-step="#step_policy"><i class="fa fa-bank"></i> <?php esc_html_e('Hotel Policy',ST_TEXTDOMAIN) ?></li>
                    <?php if(!empty($post_id)){ ?>
                        <li data-step="#step_inventory"><i class="fa fa-book"></i> <?php _e("Inventory",ST_TEXTDOMAIN) ?></li>
                    <?php } ?>
            ...
            <div class="add_service_step_wraps">
                <div class="add_service_step active" id="step_general">
                    ...
                    <div class="form-group form-group-icon-left">
                        ...
                        <input data-rules="required" id="title" name="st_title" type="text" placeholder="<?php _e("Title",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo stripslashes(STInput::request("st_title",$title)) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea data-rules="required" id="desc" name="st_desc" rows="6"  class="form-control"><?php echo stripslashes(STInput::request("st_desc",$excerpt)) ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 partner_map">
                            <div class="form-group form-group-icon-left">
                                ...
                                <?php st_validate_msg(esc_html__("The Hotel Address field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <?php
                ...
                <div class="add_service_step" id="step_hotel_detail">
                    <div class="row">
                        <?php
                       ...
                       <!-- <div class="col-md-12">
                            ...
                            <?php /*//st_validate_msg(esc_html__("The Hotel accepted payment by field is required.",ST_TEXTDOMAIN),'required') */?>
                        </div>-->
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <i class="fa  fa-envelope-o input-icon input-icon-hightlight"></i>
                                <input data-rules="required,valid_email" id="email" name="email" type="text" placeholder="<?php _e('Hotel email', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo STInput::request('email',get_post_meta( $post_id , 'email' , true)) ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('email'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Hotel Email field is required.",ST_TEXTDOMAIN),'required') ?>
                                <?php st_validate_msg(esc_html__("The Hotel Email field must be a valid email.",ST_TEXTDOMAIN),'valid_email') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <input data-rules="required" id="phone" name="phone" type="text" placeholder="<?php _e('Hotel phone number', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo STInput::request('phone',get_post_meta( $post_id , 'phone' , true)) ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('phone'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Hotel Phone Number field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <input data-rules="required" id="hotel_star" name="hotel_star" type="text" placeholder="<?php _e("Hotel star",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo STInput::request('hotel_star',get_post_meta( $post_id , 'hotel_star' , true)) ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('hotel_star'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Hotel Star field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <div class="upload-wrapper upload-partner-wrapper">
                                    ...
                                    <input data-rules="required" type="hidden" class="save-image-id" name="id_logo" value="<?php echo $logo; ?>">
                                </div>
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('logo'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Hotel Logo field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left">
                                ...
                                <div class="upload-wrapper upload-mul-partner-wrapper">
                                    ...
                                    <input data-rules="required" type="hidden" class="save-image-id" name="id_gallery" value="<?php echo $gallery; ?>">
                                </div>
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('gallery'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Hotel Gallery field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="add_service_step" id="step_check_in_out_time">
                    <div class="row">
                ...
                <div class="add_service_step" id="step_other_options">
                    <div class="row">
                        <div class='col-md-12'>
                            <div class="form-group">
                                ...
                                <input data-rules="required" id="hotel_booking_period" name="hotel_booking_period" type="text" min="0" placeholder="<?php _e("Book before number of day",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo STInput::request('hotel_booking_period',get_post_meta($post_id,'hotel_booking_period',true)) ?>">
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('hotel_booking_period'),'danger') ?></div>
                                <?php st_validate_msg(esc_html__("The Booking period field is required.",ST_TEXTDOMAIN),'required') ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="add_service_step" id="step_policy">
                    <div class="row">
                        <div class='col-md-12'>
                            <div class="form-group">
                ...
                <?php if(!empty($post_id)){ ?>
                    <div class="add_service_step user-inventory" id="step_inventory">
                        <div class="row">
                            <div class="col-xs-12">
                                <?php
