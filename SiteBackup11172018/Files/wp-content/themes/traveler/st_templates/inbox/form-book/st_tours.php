        ...
        <div class="st-inbox-form-book">
            ...
            <div class="section">
                <div class="package-book-now-button">
                    ...
                    <input type="hidden" name="item_id" value="<?php echo $post_id; ?>">
                    ...
                    <div class="div_book">
                        <div class="booking-meta">
                            ...
                            <!--Starttime-->
                                <input type="hidden" data-starttime="<?php echo $starttime_value; ?>"
                                       ...
                                       data-tourid="<?php echo $post_id; ?>" id="starttime_hidden_load_form"/>
                                <div class="mt10 mb20"
                                                                                    ...
                                                                                    <tr class="extra-collapse-control extra-none">
                                                                                        <td width="100%" class="tour-package-hotel-check">
                                                                                            ...
                                                                                            <label for="hotel-custom-<?php echo $key; ?>"
                                                                                                   class="ml20"><?php echo $val->hotel_name . ' (' . TravelHelper::format_money($val->hotel_price) . ')'; ?>
																		                        <?php
																		                        $star = $val->hotel_star;
																		                        echo '<ul class="icon-list icon-group booking-item-rating-stars">';
																		                        echo TravelHelper::rate_to_string($star);
                                                                                    ...
                                                                                    <tr class="extra-collapse-control extra-none">
                                                                                        <td width="100%" class="tour-package-hotel-check car-check">
                                                                                            ...
                                                                                            <label for="activity-custom-<?php echo $key; ?>"
                                                                                                   class="ml20"><?php echo $val->activity_name . ' (' . TravelHelper::format_money($val->activity_price) . ')'; ?>
                                                                                            </label>
                                                                                        </td>
                                                                                    </tr>
														                        <?php endforeach; ?>
                                                                                    ...
                                                                                    <tr class="extra-collapse-control extra-none">
                                                                                        <td width="80%" class="tour-package-hotel-check car-check">
                                                                                            <label for="car-custom-<?php echo $key; ?>"
                                                                                                   class="ml20"><?php echo $val->car_name . ' (' . TravelHelper::format_money($val->car_price) . ')'; ?>
                                                                                            </label>
                                                                                        </td>
                                                                                        <td width="20%">
											                                    ...
											                                    <?php foreach ($flight_package as $key => $val): ?>
                                                                                    <tr class="extra-collapse-control extra-none">
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <label class="ml20 mb10"><input type="radio" <?php echo in_array($flight_id . '_economy', $flight_ids_selected) ? 'checked' : ''; ?> class="i-check flight_package" name="flight_package[<?php echo $flight_id; ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_economy)); ?>"/><span class="mt2 d-i-b"> <?php echo TravelHelper::format_money($val->flight_price_economy); ?></span></label>
		                                                                                    <?php $flight_package_data_business->flight_price_type = 'business'; ?>
	                                                                                        <?php echo __('Business', ST_TEXTDOMAIN); ?><br />
                                                                                            <label class="ml20"><input type="radio" <?php echo in_array($flight_id . '_business', $flight_ids_selected) ? 'checked' : ''; ?> class="i-check flight_package" name="flight_package[<?php echo $flight_id; ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_business)); ?>"/><span class="mt2 d-i-b"> <?php echo TravelHelper::format_money($val->flight_price_business); ?></span></label>
                                                                                        </td>
                                                                                    </tr>
											                                    <?php endforeach; ?>
										                                    <?php } } ?>
											                                    ...
											                                    <?php foreach ($flight_package_custom as $key => $val): ?>
                                                                                    <tr class="extra-collapse-control extra-none">
                                                                                        ...
                                                                                        <td>
		                                                                                    <?php $flight_package_data_economy->flight_price_type = 'economy'; ?>
	                                                                                        <?php echo __('Economy', ST_TEXTDOMAIN); ?><br />
                                                                                            <label class="ml20 mb10"><input type="radio" <?php echo in_array($key . '_economy', $flight_ids_selected) ? 'checked' : ''; ?> class="i-check flight_package" name="flight_package[<?php echo $key; ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_economy)); ?>"/><span class="mt2 d-i-b"><?php echo TravelHelper::format_money($val->flight_price_economy); ?></span></label>
		                                                                                    <?php $flight_package_data_business->flight_price_type = 'business'; ?>
	                                                                                        <?php echo __('Business', ST_TEXTDOMAIN); ?><br />
                                                                                            <label class="ml20"><input type="radio" <?php echo in_array($key . '_business', $flight_ids_selected) ? 'checked' : ''; ?> class="i-check flight_package" name="flight_package[<?php echo $key; ?>][]" value="<?php echo htmlspecialchars(json_encode($flight_package_data_business)); ?>"/><span class="mt2 d-i-b"> <?php echo TravelHelper::format_money($val->flight_price_business); ?></span></label>
                                                                                        </td>
                                                                                    </tr>
											                                    <?php endforeach; ?>
										                                    <?php } } ?>
                        ...
                        <div class="div_btn_book_tour">
		                    ...
		                    if ($st_is_booking_modal && $tour_external_booking == 'off') {
			                    ?>
                                <a data-target="#tour_booking_<?php echo $post_id; ?>"
...
if ($st_is_booking_modal) {
	?>
    <div class="mfp-with-anim mfp-dialog mfp-search-dialog mfp-hide" id="tour_booking_<?php echo $post_id; ?>">
