                    ...
                    <div class="div_book">
                        <div class="booking-meta">
                            ...
                            <input type="hidden" data-starttime="<?php echo $starttime_value; ?>"
                                   data-checkin="<?php echo $check_in; ?>" data-checkout="<?php echo $check_out; ?>" data-tourid="<?php echo $post_id; ?>" id="starttime_hidden_load_form"/>
                        ...
                        <div class="div_btn_book_tour">
		                    ...
		                    if ($st_is_booking_modal && $activity_external_booking == 'off') {
			                    ?>
                                <a data-target="#activity_booking_<?php echo $post_id; ?>" onclick="return false"
...
if ($st_is_booking_modal) {
	?>
    <div class="mfp-with-anim mfp-dialog mfp-search-dialog mfp-hide" id="activity_booking_<?php echo $post_id; ?>">
