...
?>
    <form  id="form-booking-inpage" method="post" class="car_booking_form"  <?php echo $car_data_type; ?>>
	    <?php
	    $current_rate = 1;
		...
		<div class="st-inbox-form-book booking-item-price-calc" data-car-id="<?php echo $post_id; ?>">
			<div class="section">
					...
					<div class="div_book">
						...
						<div class="div_btn_book_tour">
							...
							if($st_is_booking_modal && $car_external_booking == 'off'){
								?>
                                <a href="#car_booking_<?php echo $post_id; ?>" class="btn btn-primary btn-st-add-cart" onclick="return false" data-target=#car_booking_<?php echo $post_id; ?>  data-effect="mfp-zoom-out" ><?php st_the_language('book_now') ?> <i class="fa fa-spinner fa-spin"></i></a>
							<?php }else{ ?>
								<?php
								$car_external_booking = get_post_meta($post_id, 'st_car_external_booking', "off");
...
if($st_is_booking_modal){?>
    <div class="mfp-with-anim mfp-dialog mfp-search-dialog mfp-hide" id="car_booking_<?php echo $post_id; ?>">
