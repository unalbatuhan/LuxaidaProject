...
<div data-tp-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange input-daterange-return form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    <label for="amd-field-return-date"><?php echo esc_html( $title)?></label>
    <i class="fa fa-calendar input-icon input-icon-highlight"></i>
    <input <?php echo esc_attr($is_required) ?> placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" readonly class="form-control amd_return_date <?php echo esc_attr($is_required) ?>" value="" type="text" />
    <input type="hidden" name="return_date" class="amd-date-to" value="">
