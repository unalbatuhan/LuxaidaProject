...
<li class="<?php echo esc_attr( $class ); ?>">
	<a id="show-mini-cart-button" href="<?php echo esc_url( $cart_url ); ?>"><i class="fa fa-shopping-cart"></i><span class="badge"><?php echo $cart_total_item; ?></span></a>
				...
				<div class="traveler-cart-item">
					<div class="row">
						...
						<div class="col-xs-8">
							...
							?>
								<h4 class="traveler-cart-title"><a href="<?php echo get_the_permalink( $room_id ) ?>"><?php echo $post_title; ?></a></h4>
							<?php else: ?>	
								<h4 class="traveler-cart-title"><a href="<?php echo get_the_permalink( $post_id ) ?>"><?php echo $post_title; ?></a></h4>
							<?php endif; ?>
...
?>
<li class="<?php echo esc_attr( $class ); ?>">
	<a id="show-mini-cart-button" href="<?php echo esc_url( $check_out_url ); ?>"><i class="fa fa-shopping-cart"></i><span class="badge"><?php echo $cart_total_item; ?></span></a>
	<?php if( $cart_total_item ): ?>
	<div class="traveler-cart-mini">
		<div class="traveler-cart-header">
		...
		?>
			<a href="<?php echo esc_url( $check_out_url ); ?>" class="text-center <?php echo $class; ?> pull-left" <?php echo $attr; ?>><?php echo __('Checkout', ST_TEXTDOMAIN ); ?></a>
			<a href="<?php echo add_query_arg(array('action' => 'st-remove-cart', 'security' => wp_create_nonce( 'st-security' ))); ?>" class="minicart-remove pull-right"><?php echo __('Remove Cart', ST_TEXTDOMAIN); ?></a>
		</div>
	</div>
	<?php endif; ?>
