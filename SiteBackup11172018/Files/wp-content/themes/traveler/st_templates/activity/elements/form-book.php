                    ...
                    <div class="row ">
                        <div class="col-xs-12 ">
                            ...
                            <input data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" readonly="readonly"
                                   ...
                                   id="check_in" type="text" name="check_in" value="<?php echo $check_in; ?>"
                                   class="form-control">
                        </div>
                        <div class="col-xs-12 mt10" style="display: none;">
                            ...
                            <input data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" readonly="readonly"
                                   id="check_out" type="text" name="check_out" value="<?php echo $check_out; ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 mb5" style="display: none">
                            ...
                            <input readonly="readonly" id="check_out" type="text" name="check_out"
                                   value="<?php echo $check_out; ?>" class="form-control">
                        </div>
                    </div>
