            ...
            <ul class="booking-item-payment-price">
                ...
                <?php if($adult_number) {?>
                    <li>
                        ...
                        <p class="booking-item-payment-price-amount"><?php echo $adult_number; ?></p>
                    </li>
                <?php }?>
                ...
                <?php if($child_number) {?>
                    <li>
                        ...
                        <p class="booking-item-payment-price-amount"><?php echo $child_number; ?></p>
                    </li>
                <?php }?>
                <?php if($infant_number) {?>
                    <li>
                        <p class="booking-item-payment-price-title"><?php _e('Number of Infant',ST_TEXTDOMAIN) ?> </p>
                        <p class="booking-item-payment-price-amount"><?php echo $infant_number; ?></p>
                    </li>
                <?php }?>
                <?php
