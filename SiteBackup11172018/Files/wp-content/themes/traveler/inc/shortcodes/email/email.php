...
if( !function_exists('get_email_has_refund_template')){
    function get_email_has_refund_template(){
        ...
        return '<table id="booking-infomation" class="wrapper" style="width: 1000px;" width="90%" cellspacing="0" align="center">
            <tbody>
            <tr>
            <td style="padding: 20px 10px; background: #ED8323;" width="20%"><a href="'. site_url().'"> <img class="alignnone wp-image-7442 size-full" src="'. $logo .'" alt="logo" width="110" height="40" /> </a></td>
            ...
            <tr>
            <td align="center">'. $social_icon .'</td>
            </tr>
            <tr>
            <td style="padding-top: 20px;" align="center">
            <p>Booking, reviews and advices on hotels, resorts, flights, vacation rentals, travel packages, and lots more!</p>
...
if( !function_exists('get_email_cancel_booking_success_template')){
    function get_email_cancel_booking_success_template(){
        ...
        return '<table id="booking-infomation" class="wrapper" style="width: 1000px;" width="90%" cellspacing="0" align="center">
            ...
            [st_email_cancel_booking_success]
            <table style="color: #818181; width: 1000px;" width="100%" cellspacing="0" align="center">
            <tbody>
            <tr>
            <td style="padding-top: 30px; padding-bottom: 20px;" align="center"><hr style="color: #ddd;" /></td>
...
if(!function_exists('st_default_email_template_for_admin_partner')){
    function st_default_email_template_for_admin_partner(){
        ...
        return '
            ...
            <tr>
            <td>
                [st_is_partner_register]Have a new user register as <strong style="color:#ed8323">Partner</strong>. Please check info below:[/st_is_partner_register]
                [st_is_partner_update]Have a new user update certificates as <strong style="color:#ed8323">Partner</strong>. Please check info below:[/st_is_partner_update]
            </td>
            </tr>
            <tr>
...
if(!function_exists('st_default_email_register_user_normal_template_for_admin')){
    function st_default_email_register_user_normal_template_for_admin(){
        ...
        return '
            ...
            <tr>
            <td>
               Have a new user register as <strong style="color:#ed8323">Normal</strong>. Please check info below:
            </td>
            </tr>
            <tr>
            <td style="padding-top: 40px; font-size: 40px; font-weight: 600;">
...
if(!function_exists('st_default_admin_new_request_withdrawal')){
    function st_default_admin_new_request_withdrawal(){
        ...
        return '
            ...
            <tr>
            <td  style="padding-bottom: 20px; font-size: 20px; padding-top: 50px; text-align: center;">
                 <a href="[st_url_admin_withdrawal]" target="_blank"  style=" background-color: #ed8323;border-radius: 5px;
    color: #fff;
    font-family: tahoma;
    font-size: 14px;
    font-weight: 700;
...
if(!function_exists('st_email_member_packages_admin')){
    function st_email_member_packages_admin(){
        ...
        return '<table id="booking-infomation" class="wrapper" style="width: 800px;" width="90%" cellspacing="0" align="center">
        <tbody>
        <tr>
        <td style="padding: 20px 10px; background: #ED8323;" width="20%"><img class="alignnone size-full wp-image-6208" src="'.$logo.'" alt="" width="110" height="40" /></td>
        <td style="background: #ed8323 none repeat scroll 0 0; color: #fff; font-size: 17px; padding: 21px 45px; text-align: right;" width="80%"><a style="color: #fff; padding-left: 12px; text-decoration: none;" href="#">Hotel</a> <a style="color: #fff; padding-left: 20px; text-decoration: none;" href="#">Rental</a> <a style="color: #fff; padding-left: 20px; text-decoration: none;" href="#">Car</a> <a style="color: #fff; padding-left: 20px; text-decoration: none;" href="#">Tour</a> <a style="color: #fff; padding-left: 20px; text-decoration: none;" href="#">Activity</a></td>
        </tr>
        </tbody>
        </table>
