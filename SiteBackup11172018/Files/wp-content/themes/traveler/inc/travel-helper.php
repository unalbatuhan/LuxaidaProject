<?php
    ...
    if (!class_exists('TravelHelper')) {
        ...
        class TravelHelper
        {
            ...
            static function init()
            {
                ...
                if (function_exists('icl_get_languages')) {
                    add_action('init', array(__CLASS__, 'change_language_wpml'));
                }
                if (function_exists('qtranxf_init_language')) {
                    add_action('init', array(__CLASS__, 'change_language_qtrans'));
                }
	            ...
	            foreach( $invalidate_actions as $action ) {
		            add_action( $action, array(__CLASS__, 'st_delete_menu_transients') );
	            }
            }

	        static function st_nav_menu( $args = array() ) {
            ...
            static public function st_author_contact()
            {
                ...
                $message .= st()->load_template('email/author_contact', false, array('data' => $data));
        ...
        */
            ...
            static function getLazyLoadingImage($size = array(100, 100, 'bfi_thumb'=>true)){
                ...
                <div class="layzyload-wrapper">
                    ...
                    <img class="st-lazy" data-src="<?php echo $thumb_src; ?>" alt="<?php echo $thumb_alt; ?>" style="display: none"/>
                </div>
                <?php
            }
        }
