...
//        ) ) );
    ...
    function enqueue_scripts_mobile(){
	    //Menu
        //wp_dequeue_script('slimmenu');
	    //Render custom file - MENU
        //wp_enqueue_style('mobile-menu', get_template_directory_uri() . '/css/mobile_menu.css');
	    //wp_enqueue_script('mobile-menu',get_template_directory_uri().'/js/mobile_menu.js',array('jquery'),null,true);
	    //End render custom file
    }
...
//            wp_enqueue_script( 'custom.js', get_template_directory_uri() . '/js/custom.js', [ 'jquery' ], null, true );
            ...
            wp_register_script( 'st-twocheckout-js', get_template_directory_uri() . '/js/2checkout.js', [ '2co-min-js' ], null, true );
            ...
            wp_enqueue_script('traveler',get_template_directory_uri().'/dist/traveler.min.js',array('jquery'),null,true);
